...
import ellipseup from "../images/png/card-ellipse-up.png";
import ellipsedown from "../images/png/card-ellipse-down.png";
const Utitle = () => {
  return (
    <>
      <section className="bg_black">
        <div className="container">
          <h2 className="text-center color_white fs_xxl mb-0 fw-normal ff_azo">
            Utilities
          </h2>
          <div className="row justify-content-center py-5">
            <div className="col-md-4 col-sm-6 my-3 my-lg-0 col-10">
              <div className="d-flex flex-column align-items-center justify-content-between bg_grey blur border position-realtive p-22 u-card transition-card">
                <div className="ellipse-up z-0">
                  <img src={ellipseup} alt="ellipseup" />
                </div>
                <div className="ellipse-down z-0">
                  <img src={ellipsedown} alt="ellipsedown" />
                </div>
                ...
                <div className="z-1">
                  <h4 className="ff_montserrat fs_md color_white mb-0 fw-semibold text-center paddingtop-22px hover-black">
                    Document
                  </h4>
                  <p className="ff_montserrat fs_sm color_white mb-0 fw-normal text-center mw-330px paddingtop-14px lh-25px hover-black">
                    Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae
                    viverra amet et. Erat nam molestie. Vitae mollis lacus
                    senectus mattis nisl. Porta , adipiscing sed mus diam amet,
                    ac sed tellus.
                  </p>
                </div>
              </div>
